        ...
        <div class="text-left">
            <form>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" readonly class="form-control-plaintext" id="foto" value="<?php echo $result[0]['foto']; ?>">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="text-right">
                    <a class="btn btn-primary" role="button" href="ProjIndex.php">Tornar als Projectes</a>
                </div>
            </form>				
        </div>
    </div>
